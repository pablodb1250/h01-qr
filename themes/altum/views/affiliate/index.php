        ...
        <div class="col">
            <div class="row">
                <div class="col-12 mb-4">
                    <div class="card bg-gray-50 border-0 h-100">
                        <div class="card-body d-flex flex-column">
                            <span class="h3 text-gray-500"><?= sprintf(l('affiliate.commission_percentage.header'), settings()->affiliate->commission_percentage . '%') ?></span>
                ...
                <div class="col-12 mb-4">
                    <div class="card bg-gray-50 border-0 h-100">
                        <div class="card-body d-flex flex-column">
                            <span class="h3 text-gray-500"><?= sprintf(l('affiliate.minimum_withdrawal_amount.header'), settings()->affiliate->minimum_withdrawal_amount . ' ' . settings()->payment->currency) ?></span>
...
<?php if(settings()->users->register_is_enabled): ?>
    <div class="mt-8 bg-gray-50 py-6">
        <div class="container">
