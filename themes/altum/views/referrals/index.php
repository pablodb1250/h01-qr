        ...
        <div class="col-12 col-xl mb-3 mb-xl-0">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <span class="h3 m-0 text-gray-500"><?= nr($data->referrals_statistics->referrals) ?></span>
                    </div>
        ...
        <div class="col-12 col-xl mb-3 mb-xl-0">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <span class="h3 m-0 text-gray-500"><?= nr($data->referrals_statistics->converted_referrals) ?></span>
                    </div>
        ...
        <div class="col-12 col-xl mb-3 mb-xl-0">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <span class="h3 m-0 text-gray-500"><?= nr($data->pending_affiliate_commissions, 2) . ' ' . settings()->payment->currency ?></span>
                    </div>
        ...
        <div class="col-12 col-xl mb-3 mb-xl-0">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <span class="h3 m-0 text-gray-500"><?= nr($data->approved_affiliate_commissions, 2) . ' ' . settings()->payment->currency ?></span>
                    </div>
