...
<div class="container">
    ...
    <form action="" method="post" role="form">
        ...
        <div class="">
            <h1 class="h4"><?= l('account.settings.header') ?></h1>
        ...
        <div class="" id="billing" style="<?= !settings()->payment->is_enabled || !settings()->payment->taxes_and_billing_is_enabled ? 'display: none;' : null ?>">
            <h1 class="h4"><?= l('account.billing.header') ?></h1>
        ...
        <div class="">
            <h1 class="h4"><?= l('account.twofa.header') ?></h1>
        ...
        <div class="">
            <h1 class="h4"><?= l('account.change_password.header') ?></h1>
