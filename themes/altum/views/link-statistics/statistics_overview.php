...
<div class="row">
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php if($key): ?>
                                    <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=city_name&country_code=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class="align-middle"><?= $key ? get_country_from_country_code($key) : l('link_statistics.statistics.country_unknown') ?></a>
                                <?php else: ?>
                                    <span class="align-middle"><?= $key ? get_country_from_country_code($key) : l('link_statistics.statistics.country_unknown') ?></span>
                                <?php endif ?>
                            </div>
            ...
            <div class="px-3 py-2">
                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=country&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><?= l('link_statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="px-3 py-2">
                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=referrer_host&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><?= l('link_statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                ...
                <?php $i = 0; foreach($data->statistics['device_type'] as $key => $value): $i++; if($i > 5) break; ?>
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                <?php if(!$key): ?>
                                    <span><?= l('link_statistics.statistics.device_type_unknown') ?></span>
                                <?php else: ?>
                                    <span><?= l('link_statistics.statistics.device_' . $key) ?></span>
                                <?php endif ?>
                            </div>
            ...
            <div class="px-3 py-2">
                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=device&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><?= l('link_statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                ...
                <?php $i = 0; foreach($data->statistics['os_name'] as $key => $value): $i++; if($i > 5) break; ?>
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                <?php if(!$key): ?>
                                    <span><?= l('link_statistics.statistics.os_unknown') ?></span>
                                <?php else: ?>
                                    <span><?= $key ?></span>
                                <?php endif ?>
                            </div>
            ...
            <div class="px-3 py-2">
                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=os&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><?= l('link_statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                ...
                <?php $i = 0; foreach($data->statistics['browser_name'] as $key => $value): $i++; if($i > 5) break; ?>
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                <?php if(!$key): ?>
                                    <span><?= l('link_statistics.statistics.browser_unknown') ?></span>
                                <?php else: ?>
                                    <span><?= $key ?></span>
                                <?php endif ?>
                            </div>
            ...
            <div class="px-3 py-2">
                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=browser&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><?= l('link_statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                ...
                <?php $i = 0; foreach($data->statistics['browser_language'] as $key => $value): $i++; if($i > 5) break; ?>
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                <?php if(!$key): ?>
                                    <span><?= l('link_statistics.statistics.language_unknown') ?></span>
                                <?php else: ?>
            ...
            <div class="px-3 py-2">
                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=language&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><?= l('link_statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
