...
<div class="container">
    ...
    <?php if(!count($data->pageviews)): ?>
        ...
        <div class="d-flex flex-column align-items-center justify-content-center text-center">
            <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-5 mb-3" alt="<?= l('link_statistics.no_data') ?>" />
            <h2 class="h4 text-muted mt-3"><?= l('link_statistics.no_data') ?></h2>
