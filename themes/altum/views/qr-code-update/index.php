                        ...
                        <div class="collapse" id="colors_container">
                            <div class="form-group">
                                ...
                                <select id="foreground_type" name="foreground_type" class="form-control" data-reload-qr-code>
                                    <option value="color" <?= $data->qr_code->settings->foreground_type == 'color' ? 'selected="selected"' : null?>><?= l('qr_codes.input.foreground_type_color') ?></option>
                                    <option value="gradient" <?= $data->qr_code->settings->foreground_type == 'gradient' ? 'selected="selected"' : null?>><?= l('qr_codes.input.foreground_type_gradient') ?></option>
                                </select>
                            </div>
            ...
            <div class="row mb-4 d-print-none">
                ...
                <div class="col-12 col-lg-6 mb-3 mb-lg-0 dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?= UPLOADS_FULL_URL . 'qr_codes/logo/' . $data->qr_code->qr_code ?>" id="download_svg" class="dropdown-item" download="<?= settings()->main->title . '.svg' ?>"><?= l('qr_codes.download_svg') ?></a>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'png', '<?= $data->qr_code->name . '.png' ?>');"><?= l('qr_codes.download_png') ?></button>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'jpg', '<?= $data->qr_code->name . '.jpg' ?>');"><?= l('qr_codes.download_jpg') ?></button>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'webp', '<?= $data->qr_code->name . '.webp' ?>');"><?= l('qr_codes.download_webp') ?></button>
                    </div>
                </div>
            </div>
