            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between mb-3">
                    <h5 class="modal-title">
                        ...
                        <?= l('admin_page_delete_modal.header') ?>
                    </h5>
                ...
                <p class="text-muted"><?= l('admin_page_delete_modal.subheader') ?></p>

                <div class="mt-4">
                    <a href="" id="page_delete_modal_url" class="btn btn-lg btn-block btn-danger"><?= l('global.delete') ?></a>
                </div>
            </div>
