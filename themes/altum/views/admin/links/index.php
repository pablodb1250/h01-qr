                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="search_by" id="filters_search_by" class="form-control form-control-sm">
                                <option value="url" <?= $data->filters->search_by == 'url' ? 'selected="selected"' : null ?>><?= l('admin_links.filters.search_by_url') ?></option>
                                <option value="location_url" <?= $data->filters->search_by == 'location_url' ? 'selected="selected"' : null ?>><?= l('admin_links.filters.search_by_location_url') ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                ...
                                <option value="url" <?= $data->filters->order_by == 'url' ? 'selected="selected"' : null ?>><?= l('admin_links.filters.order_by_url') ?></option>
                                <option value="location_url" <?= $data->filters->order_by == 'location_url' ? 'selected="selected"' : null ?>><?= l('admin_links.filters.order_by_location_url') ?></option>
                                <option value="pageviews" <?= $data->filters->order_by == 'pageviews' ? 'selected="selected"' : null ?>><?= l('admin_links.filters.order_by_pageviews') ?></option>
                            </select>
                        </div>
    ...
    <table class="table table-custom">
        ...
        <?php foreach($data->links as $row): ?>
            <tr>
                ...
                <td class="text-nowrap">
                    <div class="d-flex flex-column">
                        <span class="text-muted"><?= sprintf(l('admin_links.table.pageviews'), nr($row->pageviews)) ?></span>
                    </div>
                </td>
                <td class="text-nowrap">
