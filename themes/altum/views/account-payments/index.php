        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                    <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-5 mb-3" alt="<?= l('account_payments.payments.no_data') ?>" />
                    <h2 class="h4 text-muted mt-3"><?= l('account_payments.payments.no_data') ?></h2>
                </div>
            </div>
        </div>
    <?php endif ?>
