...
class Link extends Controller {
    ...
    public function index() {
        ...
        $this->has_access = !$this->link->password || ($this->link->password && isset($_COOKIE['link_password_' . $this->link->link_id]) && $_COOKIE['link_password_' . $this->link->link_id] == $this->link->password);
        ...
        if(!$this->has_access && !empty($_POST)) {
            ...
            if(!password_verify($_POST['password'], $this->link->password)) {
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                /* Set a cookie */
                setcookie('link_password_' . $this->link->link_id, $this->link->password, time()+60*60*24*30);

                header('Location: ' . $this->link->full_url); die();
